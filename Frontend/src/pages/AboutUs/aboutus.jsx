        ...
        <div className="container overflow-hidden">
            ...
            <div className="col-12 col-lg-6">
                ...
                <div className="card border-0">
                    <img className="card-img-top img-fluid m-0" loading="lazy" src={pic1} alt=""/>
            ...
            <div className="col-12 col-lg-6">
                <article>
                <div className="card border-0">
                    <img className="card-img-top img-fluid m-0" loading="lazy" src={pic2} alt=""/>
                    <div className="card-body border bg-white p-4">
                    <div className="entry-header mb-3">
                        <h2 className="card-title entry-title h4 mb-0">
            ...
            <div className="container overflow-hidden">
                ...
                <div className="col-12 col-md-6 col-lg-4">
                    ...
                    <div className="card-body p-0">
                        ...
                        <img className="img-fluid" loading="lazy" src={pic3} alt="Flora Nyra"/>
                ...
                <div className="col-12 col-md-6 col-lg-4">
                    ...
                    <div className="card-body p-0">
                        <figure className="m-0 p-0">
                        <img className="img-fluid" loading="lazy" src={pic5} alt="Evander Mac"/>
                        <figcaption className="m-0 p-4">
                ...
                <div className="col-12 col-md-6 col-lg-4">
                    ...
                    <div className="card-body p-0">
                        <figure className="m-0 p-0">
                        <img className="img-fluid" loading="lazy" src={pic4} alt="Taytum Elia"/>
                        <figcaption className="m-0 p-4">
                ...
                <div className="col-12 col-lg-7 overflow-hidden">
                    ...
                    <div className="col-12 col-sm-6">
                        ...
                        <div className="card-body text-center p-4 p-xxl-5">
                            ...
                            <h4 className="mb-4">Cultural Insigt & Blogs</h4>
                            <p className="mb-4 text-secondary">We can help you to understand your target market and identify new opportunities for growth. We offer a variety of research services.</p>
                    ...
                    <div className="col-12 col-sm-6">
                        ...
                        <div className="card-body text-center p-4 p-xxl-5">
                            ...
                            <h4 className="mb-4">Social Connectivity</h4>
                            <p className="mb-4 text-secondary">We can help you to create a visually appealing and user-friendly website. We take into account your brand identity and target audience.</p>
                            <a href="#!" className="fw-bold text-decoration-none link-primary">
                            Learn More
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
                    ...
                    <div className="col-12 col-sm-6">
                        ...
                        <div className="card-body text-center p-4 p-xxl-5">
                            ...
                            <h4 className="mb-4">Chatbot Support</h4>
