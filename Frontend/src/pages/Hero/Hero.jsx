        ...
        <div className="carousel-inner" style={{ borderRadius: 0 }}>
          <div className="carousel-item active">
            <div style={textStyle} className='px-lg-5'>
              <h1 style={{color : 'white', fontSize:"32px"}}> Connecting Cultures <br></br>
              ...
              <button style={{fontSize: 20, margin: 5}} className="btn btn-primary">Login</button>
              <button style={{fontSize: 20, margin: 5}} className="btn btn-secondary mx-3">Signup</button>
            </div>
          ...
          <div className="carousel-item">
            <div style={textStyle} className='px-lg-5'>
              ...
              <p className='py-lg-3'>Lorem ipsum dolor sit amet, consectetur adipisicing <br /> elit. Nam optio dicta accusantium magnam <br /> sint repudiandae, consectetur quasi iste aliquam id?</p>
              <button style={{fontSize: 20, margin: 5}} className="btn btn-primary">Login</button>
              <button style={{fontSize: 20, margin: 5}} className="btn btn-light mx-3">Signup</button>
            </div>
